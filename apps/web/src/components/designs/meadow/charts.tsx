/**
 * Meadow's hand-rolled SVG charts. Gentle curves, pastel fills, no chart
 * library — full control over softness, deterministic server/client output
 * (no hydration windows), and exactly the shapes the concept needs.
 */
