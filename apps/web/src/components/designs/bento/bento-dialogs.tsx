...
/**
 * Bento's form containers: glazed dialogs instead of side sheets. The flows
 * themselves come from the container-independent forms module; everything
 * here is chrome — the rounded, edge-lit tile look the concept uses.
 */
